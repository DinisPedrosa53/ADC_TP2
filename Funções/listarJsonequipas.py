    ...
    try:
        ...
        if equipas:
            ...
            for equipa in equipas:
                print(f"{equipa['nome']:<20} {equipa['piloto1']:<15} {equipa['piloto2']:<15} {equipa['presidente']:<15} {equipa['fundador']:<15} {equipa['pontos']:<15}")
        else:
            print("Nenhuma equipa encontrada no ficheiro.")
    except FileNotFoundError:
        print("O ficheiro 'equipas.json' não foi encontrado.")
